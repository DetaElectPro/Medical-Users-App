...
import com.detatech.vitaluser.Activities.ShowRequestsDetailActivity;
...
public class AdminRequestAdapter extends RecyclerView.Adapter<AdminRequestAdapter.AdminRequestViewHolder> {
    ...
    public AdminRequestAdapter(Context context, List<AdminRequests> feedsList) {
...
//        options = new RequestOptions().centerCrop().placeholder(R.drawable.loading_shape).error(R.drawable.loading_shape);
    ...
    public AdminRequestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.admin_request_singleitem_recyclerview, parent, false);
