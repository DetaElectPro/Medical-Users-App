...
public class ShowRequestsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ShowRequestsFragment newInstance() {
        ShowRequestsFragment fragment = new ShowRequestsFragment();
        return fragment;
    }
...
//        return inflater.inflate(R.layout.fragment_show_requests, container, false);
        ...
        mMainView = inflater.inflate(R.layout.fragment_show_requests, container, false);
