...
import com.detatech.vitaluser.Adapters.CancelRequestAdapter;
...
public class CancelRequestsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public CancelRequestsFragment() {
    }

    public static CancelRequestsFragment newInstance() {
        CancelRequestsFragment fragment = new CancelRequestsFragment();
        return fragment;
    }
...
//        return inflater.inflate(R.layout.fragment_show_requests, container, false);
        ...
        mMainView = inflater.inflate(R.layout.fragment_cancel_requests, container, false);
...
//        checkUserToken();
        ...
        adapter = new CancelRequestAdapter(getActivity(), adminRequestsListList);
