...
public class CancelRequestsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancel_requests_detail);
        initViews();
        token = SharedPreferenceUtil.getStringValue(CancelRequestsDetailActivity.this, "access_token");
...
//        Toast.makeText(getApplicationContext(),"Order Canceled Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void accept_request2() {
        if (new InternetConnection().isInternetOn(CancelRequestsDetailActivity.this)) {
//            customDialog = new CustomDialog(CancelRequestsDetailActivity.this);
//            customDialog.setCancelable(false);
//            customDialog.show();

            pDialog2 = new SweetAlertDialog(CancelRequestsDetailActivity.this, SweetAlertDialog.PROGRESS_TYPE);
...
//                object.put("password", password.getText().toString());
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.accept_request, object, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    pDialog = new SweetAlertDialog(CancelRequestsDetailActivity.this, SweetAlertDialog.SUCCESS_TYPE);
...
//                    headers.put("Content-Type", "multipart/form-data");
    ...
    public void displayMessage(String toastString) {
        ...
        Snackbar.make(CancelRequestsDetailActivity.this.getCurrentFocus(), toastString, Snackbar.LENGTH_SHORT)
